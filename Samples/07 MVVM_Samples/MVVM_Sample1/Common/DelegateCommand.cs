...
namespace MVVM_Sample1.Common
{
    ...
    public class DelegateCommand<T> : ICommand
    {
        ...
        {   
            // wir statten diesen Event mit dem add- und dem remove-Accessor aus, damit wir 
            // uns ausserhalb nicht selbst um das Auslösen des Events kümmern müssen (wir können uns so 
            // auf die Logik des CommandManagers verlassen). 
